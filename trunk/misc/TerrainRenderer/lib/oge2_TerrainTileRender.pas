...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        lst[kk][0].V[0] := HeightData.XLeft + ii;
        lst[kk][0].V[1] := HeightData.YTop + jj;
        lst[kk][0].V[2] := HeightData.GetHeight(ii, jj) / 128;
        lst[kk][1].V[0] := HeightData.XLeft + ii + 1;
        lst[kk][1].V[1] := HeightData.YTop + jj;
        lst[kk][1].V[2] := HeightData.GetHeight(ii + 1, jj) / 128;
        lst[kk][2].V[0] := HeightData.XLeft + ii + 1;
        lst[kk][2].V[1] := HeightData.YTop + jj + 1;
        lst[kk][2].V[2] := HeightData.GetHeight(ii + 1, jj + 1) / 128;
        lst[kk][3].V[0] := HeightData.XLeft + ii;
        lst[kk][3].V[1] := HeightData.YTop + jj + 1;
        lst[kk][3].V[2] := HeightData.GetHeight(ii, jj + 1) / 128;
        kk := kk + 1;
        new(Quad);
        Quad^.V[0].V[0] := HeightData.XLeft + ii;
        Quad^.V[0].V[1] := HeightData.YTop + jj;
        Quad^.V[0].V[2] := HeightData.GetHeight(ii, jj) / 128;
        Quad^.V[1].V[0] := HeightData.XLeft + ii + 1;
        Quad^.V[1].V[1] := HeightData.YTop + jj;
        Quad^.V[1].V[2] := HeightData.GetHeight(ii + 1, jj) / 128;
        Quad^.V[2].V[0] := HeightData.XLeft + ii + 1;
        Quad^.V[2].V[1] := HeightData.YTop + jj + 1;
        Quad^.V[2].V[2] := HeightData.GetHeight(ii + 1, jj + 1) / 128;
        Quad^.V[3].V[0] := HeightData.XLeft + ii;
        Quad^.V[3].V[1] := HeightData.YTop + jj + 1;
        Quad^.V[3].V[2] := HeightData.GetHeight(ii, jj + 1) / 128;
        FQuadTree.Add(Quad);
      end;
    end;
  end;
