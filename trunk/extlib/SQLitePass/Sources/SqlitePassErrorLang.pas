...
Msg1001 = 'Unknown';
Msg1002 = 'No Error';
Msg1003 = 'A %s component has raised an exception.'; 
...
Msg3002 = 'The following functions : %s%sare missing in the currently installed SQLite library : %s.%sPlease update the installed library version.';
...
Msg2015 = 'TSqlitePassDataset.SetFSQL : Cannot set SQL while Dataset is active.';
...
Msg3980 = 'TSqlitePassTranslator.GetDatabaseTableFieldDefs :' + #13#10 + 'Unable to retrieve fields definitions for table %s .';
